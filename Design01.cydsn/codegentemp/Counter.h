...
#define Counter_CAPTURE_MODE_SOFTWARE 1u
 ...
 **************************************/
#define Counter_CAPTURE_MODE_CONF       4u
...
#define Counter_DEFAULT_COMPARE_MODE    1u
    ...
    #define Counter_DEFAULT_CAPTURE_MODE    ((uint8)((uint8)4u << Counter_CTRL_CAPMODE0_SHIFT))
#else    
    #define Counter_DEFAULT_CAPTURE_MODE    (4u )
