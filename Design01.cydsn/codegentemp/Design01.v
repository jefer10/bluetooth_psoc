...
module emFile_v1_20_3 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("d42c3063-ef28-42cf-bd74-7eca6747aaba/ed092b9b-d398-4703-be89-cebf998501f6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("d42c3063-ef28-42cf-bd74-7eca6747aaba/5ed615c6-e1f0-40ed-8816-f906ef67d531"),
	...
	cy_psoc3_pins_v1_10
		#(.id("d42c3063-ef28-42cf-bd74-7eca6747aaba/1425177d-0d0e-4468-8bcc-e638e5509a9b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d42c3063-ef28-42cf-bd74-7eca6747aaba/ae249072-87dc-41aa-9405-888517aefa28"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d42c3063-ef28-42cf-bd74-7eca6747aaba/6df85302-e45f-45fb-97de-4bdf3128e07b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module ADC_SAR_v3_10_5 (
	...
	cy_clock_v1_0
		#(.id("1e904c6d-074a-4bdf-93ae-50552a765376/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	wire [0:0] tmpOE__Pin_ADC_net;
	wire [0:0] tmpFB_0__Pin_ADC_net;
	wire [0:0] tmpIO_0__Pin_ADC_net;
	wire [0:0] tmpINTERRUPT_0__Pin_ADC_net;
	electrical [0:0] tmpSIOVREF__Pin_ADC_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_ADC
		 (.oe(tmpOE__Pin_ADC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_ADC_net[0:0]}),
		  .analog({Net_60}),
		  .io({tmpIO_0__Pin_ADC_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_ADC_net),
		  .interrupt({tmpINTERRUPT_0__Pin_ADC_net[0:0]}),
		  .annotation({Net_67}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	wire [0:0] tmpOE__Pin_ADC2_net;
	wire [0:0] tmpFB_0__Pin_ADC2_net;
	wire [0:0] tmpIO_0__Pin_ADC2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_ADC2_net;
	electrical [0:0] tmpSIOVREF__Pin_ADC2_net;

	cy_psoc3_pins_v1_10
		#(.id("2c56583b-e411-4532-a6e5-ce4325fe4334"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_ADC2
		 (.oe(tmpOE__Pin_ADC2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_ADC2_net[0:0]}),
		  .analog({Net_157}),
		  .io({tmpIO_0__Pin_ADC2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_ADC2_net),
		  .interrupt({tmpINTERRUPT_0__Pin_ADC2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_ADC2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
