...
//    UART_PutString("\r");
    ...
    UART_PutString("\r");
    UART_PutString("add_button(2,6,16,,s)");
//    UART_PutString("\r");
//    UART_PutString("add_button(2,3,17,B,B)");
    ...
    UART_PutString("\r");
    UART_PutString("add_roll_graph(6,7,5,20.0,40.0,100,T,temperatura,X-Axis,Y-Axis,0,0,1,0,0,1,medium,none,1,1,42,255,0)");
    UART_PutString("\r");
